<template>
  <div>
    <div class="headButton">
      ...
      <el-button @click="importCourse" type="primary" size="small">导入课表</el-button>
    </div>
    <div>
    ...
    <div class="el-dialog">
      ...
      <import-course-dialog ref="importCourseRef"></import-course-dialog>
    </div>
  </div>
...
import ImportCourseDialog from './dialog/ImportCourseDialog.vue'
...
export default {
  ...
  methods: {
    importCourse(){
      this.$refs.importCourseRef.openDialog()
    },

    loadList() {
      this.$axios.get("/course/courses").then(res => {
