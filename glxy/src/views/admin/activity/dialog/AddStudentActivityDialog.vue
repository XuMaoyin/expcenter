<template>
	<el-dialog title="添加活动" :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
      ...
      <el-row>
        <el-col :span="12">
          ...
          <el-form-item label="指导教师">
            <el-select v-model="form.leaderId" style="width: 150px">
        ...
        <el-col :span="12">
          ...
          <el-form-item label="申请社团">
            <el-select v-model="form.clubId" style="width: 150px">
              <el-option v-for="item in clubs" :key="item.id" :label="item.nickname" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
