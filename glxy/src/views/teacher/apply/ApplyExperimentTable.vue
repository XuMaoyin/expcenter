	...
	<div class="el-main">
      ...
      <el-table-column prop="course" label="课程名称"></el-table-column>
					...
					<el-popover trigger="click" placement="top" v-if="scope.row.type=='update'">
						...
						<el-table :data="scope.row.details">
							<el-table-column label="修改前" align="center">
								...
								<el-table-column prop="now.date" label="日期"></el-table-column>
			...
			<el-table-column label="操作" align="center" width="200">
				<template slot-scope="scope">
					<el-button size="small" type="warning" @click="pass(scope.row.id)">修改</el-button>
					<el-button size="small" type="danger" @click="refuse(scope.row.id)">取消</el-button>
				</template>
			</el-table-column>
		</el-table>
	</div>
