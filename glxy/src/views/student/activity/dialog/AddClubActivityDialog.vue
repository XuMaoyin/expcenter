    ...
    <el-form ref='addCourseForm' label-width="100px" v-model="form">
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <el-form-item label="指导教师" inline-message="">
            <el-select v-model="form.leaderId" filterable placeholder="请选择"style="width: 150px">
...
export default {
  ...
  methods: {
    ...
    diaglogBtn(val) {
      switch (val) {
        case 'sure':
          this.form.clubId = JSON.parse(sessionStorage.getItem("user")).id;
